...
export const Header = ({active}) => {
  const {barDisplay, user, token, likeTovars} = useSelector(({Reducer}) => Reducer)
  ...
  return (
    <header className="site_header" style={{background: active ? "#fff": ""}}>
      <div className="site_header__inner">
        <Link className="site__logo" onClick={() => window.location.reload()} to={"/"}>
          ...
          >
            ...
            <g xmlns="http://www.w3.org/2000/svg" class="text-color">
              ...
              <path d="M46.7986 32.3849H50.5867V17.1028L46.7986 18.3792V32.3849Z" fill={`${active ? "#000": "#fff"}`}></path>
              <path d="M61.7797 20.1442C63.5483 20.1442 65.065 21.1956 65.7744 22.6969L69.0711 20.7977C67.7005 18.1626 64.9487 16.3564 61.7797 16.3564C57.2442 16.3564 53.5573 20.043 53.5573 24.5777C53.5573 29.1087 57.2442 32.7952 61.7797 32.7952C64.9487 32.7952 67.7005 30.9895 69.0711 28.3581L65.7744 26.4548C65.065 27.9569 63.5483 29.0079 61.7797 29.0079C59.3356 29.0079 57.3495 27.0181 57.3495 24.5777C57.3495 22.134 59.3356 20.1442 61.7797 20.1442Z" fill={`${active ? "#000": "#fff"}`}></path>
              <path d="M85.5175 16.9143H80.2273L75.2224 22.0498V9.95801L71.4342 11.2347V32.3845H75.2224V27.4821L76.2701 26.4119L81.2787 32.3845H86.2273L78.924 23.6825L85.5175 16.9143Z" fill={`${active ? "#000": "#fff"}`}></path>
              <path d="M90.4653 22.6707C91.1788 21.1838 92.6878 20.1446 94.449 20.1446C96.2062 20.1446 97.7155 21.1838 98.4323 22.6707H90.4653ZM94.449 16.3564C89.9172 16.3564 86.2266 20.0429 86.2266 24.5776C86.2266 29.1082 89.9172 32.7952 94.449 32.7952C97.4788 32.7952 100.126 31.1433 101.553 28.6919L98.2596 26.796C97.4935 28.1103 96.0821 29.007 94.449 29.007C92.3955 29.007 90.6792 27.5956 90.1764 25.6964H102.585C102.634 25.3282 102.668 24.9568 102.668 24.5776C102.668 23.9209 102.585 23.2821 102.435 22.6707C101.575 19.0556 98.3241 16.3564 94.449 16.3564Z" fill={`${active ? "#000": "#fff"}`}></path>
              <path d="M114.333 28.6206C113.206 29.3418 111.697 29.4541 110.927 29.03C110.401 28.741 110.135 28.0504 110.135 26.9614V20.1292H114.472V17.1031H110.135V13.1729L106.347 14.4116V17.1031H103.561V20.1292H106.347V26.721C106.347 30.1035 108.078 31.5524 109.11 32.1194C109.996 32.6039 110.946 32.7953 111.881 32.7953C113.537 32.7953 115.155 32.1794 116.293 31.4512L114.333 28.6206Z" fill={`${active ? "#000": "#fff"}`}></path>
            </g>
            <path
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div className={`site_header__language`}>
          <button className={`border-transparent ${active && "active-header-border active-header"}`}>UZ</button>
          <button className={`border-transparent ${active && "active-header-border active-header"}`}>RU</button>
        </div>
        <nav className="site_nav">
          <ul className="site_nav__list">
            <li className="site_nav__item">
              <NavLink className={`site_nav__link ${active && "active-header-link"}`}>Все события</NavLink>
            </li>
            <li className="site_nav__item">
              <NavLink className={`site_nav__link ${active && "active-header-link"}`}>Концерты</NavLink>
            </li>
            <li className="site_nav__item">
              <NavLink className={`site_nav__link ${active && "active-header-link"}`}>Концерты</NavLink>
            </li>
            <li className="site_nav__item">
              <NavLink className={`site_nav__link ${active && "active-header-link"}`}>
            ...
            <li className="site_nav__item site_nav_bar__item">
              <NavLink className={`site_nav__link site_nav_bar__item ${active && "active-header-link"}`}>
                ...
              </NavLink>
            </li>
          </ul>
        ...
        <div className="site_header__settings">
            <NavLink className={`site_header__link site_header__like ${active ? "active-header": ""}`} to={"/like-tovars"} style={{position: "relative"}}>
              <span className="shopping__count">{token ? likeTovars.length: ""}</span>
            </NavLink>
            <button  className={`site_header__link site_header__search border-transparent`} style={{filter: active ? "invert(1)": "none"}}  to={"/search"}/>    
